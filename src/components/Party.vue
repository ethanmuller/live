...
import GamesQuest from './games/Quest.vue'
import GamesMasks from './games/Masks.vue'
import GamesPoem from './games/Poem.vue'

export default {
  components: { GamesQuest, GamesMasks, GamesPoem },
